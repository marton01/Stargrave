...
const HU = {
  ...
  powerIntro:
    'Hét rendszer, ennyi egység. Sosem elég, és minden héten másra kell. Ez közös döntés.',
  ...
  objectiveReachExit: 'El kell jutni a kijelölt pontra.',
  objectiveCollect: (n: number) => `${n} ereklyét kell begyűjteni, majd ki a kimenekítési ponton.`,
  ...
  terrainPillarText: 'Nem járható, a látást is blokkolja. A Rúnakovács tud ilyet emelni.',
  terrainTrapText:
  ...
  badgeInitiativeText:
    'Az ellenség ekkor fog lépni. A kis szám lép előbb. A ti számotok a kiválasztott lapról jön — az oldalsáv tetején látszik a teljes sorrend.',
...
const EN: Catalog = {
  ...
  powerIntro:
    'Seven systems, this many units. Never enough, and what it should go to changes every week. This is a joint decision.',
  ...
  objectiveReachExit: 'Reach the marked point.',
  objectiveCollect: (n: number) =>
    `Collect ${n} relics, then out through the extraction point.`,
  ...
  terrainPillarText: 'Not walkable, and it blocks sight. The Runesmith can raise one.',
  terrainTrapText:
  ...
  badgeInitiativeText:
    'When the enemy will act. The lower number goes first. Your own number comes from the card you chose — the sidebar shows the full order.',
